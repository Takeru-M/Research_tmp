...
from app.api.endpoints import auth, users, projects, project_files, highlights, highlight_rects, comments, s3
...
api_router.include_router(highlight_rects.router, tags=["highlight-rects"], prefix="/api/v1/highlight-rects")
